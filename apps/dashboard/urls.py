...
from .views import (
    ...
    DashboardPlatformSupportListAPIView,
    DashboardPlatformSupportCreateAPIView,
    DashboardPlatformSupportRetrieveAPIView,
    DashboardPlatformSupportUpdateAPIView,
    DashboardPlatformSupportDeleteAPIView,
    DashboardPlatformSupportMarkAsReadAPIView,
    DashboardPlatformSupportMarkAsRespondedAPIView,
...
urlpatterns = [
    ...
    path('platform-support/', DashboardPlatformSupportListAPIView.as_view(), name='platform-support-list'),
    path('platform-support/create/', DashboardPlatformSupportCreateAPIView.as_view(), name='platform-support-create'),
    path('platform-support/<int:pk>/', DashboardPlatformSupportRetrieveAPIView.as_view(), name='platform-support-detail'),
    path('platform-support/<int:pk>/update/', DashboardPlatformSupportUpdateAPIView.as_view(), name='platform-support-update'),
    path('platform-support/<int:pk>/delete/', DashboardPlatformSupportDeleteAPIView.as_view(), name='platform-support-delete'),
    path('platform-support/<int:pk>/mark-as-read/', DashboardPlatformSupportMarkAsReadAPIView.as_view(), name='platform-support-mark-as-read'),
    path('platform-support/<int:pk>/mark-as-responded/', DashboardPlatformSupportMarkAsRespondedAPIView.as_view(), name='platform-support-mark-as-responded'),
