...
from .models import AccessDevice, AccessDeviceEndpoint, AttendanceIngestEvent, DeviceCredential, DeviceUser


@admin.register(AccessDevice)
class AccessDeviceAdmin(admin.ModelAdmin):
	list_display = ("id", "name", "device_sn", "mode", "status", "is_active", "last_seen_at")
